...
public final class Crypto {
    ...
    public static func HMACSHA512(key: Data, data: Data) -> Data {
        return CryptoEthereumSwift.HMACSHA512(key: key, data: data)
    }
    ...
    public static func PBKDF2SHA512(_ password: Data, salt: Data) -> Data {
        return CryptoEthereumSwift.PBKDF2SHA512(password, salt: salt)
    }
    ...
    public static func hash160(_ data: Data) -> Data {
        return CryptoEthereumSwift.hash160(data)
    }
    ...
    public static func doubleSHA256(_ data: Data) -> Data {
        return CryptoEthereumSwift.doubleSHA256(data)
    }
    ...
    public static func hashSHA3_256(_ data: Data) -> Data {
        return CryptoEthereumSwift.hashSHA3_256(data)
    }
    ...
    public static func generatePublicKey(data: Data, compressed: Bool) -> Data {
        return CryptoEthereumSwift.generatePublicKey(data: data, compressed: compressed)
    }
    ...
    public static func sign(_ hash: Data, privateKey: Data) throws -> Data {
        return try CryptoEthereumSwift.sign(hash, privateKey: privateKey)
    }
    ...
    public static func isValid(signature: Data, of hash: Data, publicKey: Data, compressed: Bool) -> Bool {
        return CryptoEthereumSwift.isValid(signature: signature, of: hash, publicKey: publicKey, compressed: compressed)
    }
    ...
    public static func publicKey(signature: Data, of hash: Data, compressed: Bool) -> Data? {
        return CryptoEthereumSwift.publicKey(signature: signature, of: hash, compressed: compressed)
    }
